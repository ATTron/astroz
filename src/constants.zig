...
pub const earth = CelestialBody.init("earth", 5.97219e24, 3.98600e5, 2.99946e-6, 6371.0084, 6378.1366, 6356.7519, 1.49598e8, 1.47100e8, 1.52096e8, 365.26, 29.78, 0.01670, 0.00, 0.003353, 0.00108263, 1.225, 7.249, 7.2921150e-5);
...
pub const allBodies: []CelestialBody = .{
    sun,
    mercury,
    venus,
    earth,
