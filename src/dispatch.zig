...
pub fn sgp4Batch8(el: *const Sgp4Batch.BatchElements(8), tsince: @Vector(8, f64)) Sgp4.Error!Sgp4.PositionVelocity(8) {
    var out: Sgp4.PositionVelocity(8) = undefined;
    var t: [8]f64 = tsince;
    const rc = oma.resolveNoIo(Sgp4Batch8Fn, "sgp4Batch8")(@ptrCast(el), &t, @ptrCast(&out));
    return if (rc == 0) out else decode(rc);
}

pub fn sdp4Batch8(el: *const Sdp4Batch.Sdp4BatchElements(8), tsince: @Vector(8, f64), carry: *Sdp4Batch.ResonanceCarryBatch(8)) Sgp4.Error!Sgp4.PositionVelocity(8) {
    var out: Sgp4.PositionVelocity(8) = undefined;
    var t: [8]f64 = tsince;
...
pub fn sgp4Times8(sgp4: *const Sgp4, times: [8]f64) Sgp4.Error![8][2][3]f64 {
    var out: [8][2][3]f64 = undefined;
    var t: [8]f64 = times;
